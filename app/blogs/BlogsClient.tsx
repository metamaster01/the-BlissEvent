...
export default function BlogsClient() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-white py-8 md:py-12 mt-14">
      {/* <Navigation /> */}
    <div className="min-h-screen bg-white">
      {/* Hero */}
      <section className="bg-[#7D1F1F]/95 text-white">
        <div className="mx-auto max-w-6xl px-6 py-12 text-center">
          <h1 className="text-3xl font-semibold sm:text-4xl md:text-5xl">
            Our Blog
          </h1>
          <p className="mt-3 text-sm/6 sm:text-base/7 opacity-90">
            Insights, stories, and tips from The Bliss Events team.
          </p>
