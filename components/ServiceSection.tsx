...
// Desktop Service Card with onClick
...
// Mobile Service Card with onClick
const MobileServiceCard = ({ 
  ...
  return (
    <div
      ref={cardRef}
      className="rounded-2xl overflow-hidden bg-white shadow-md cursor-pointer active:scale-95 transition-transform"
      onClick={onClick}
    >
      {/* Image with Rounded Top */}
      <div className="relative h-40 overflow-hidden rounded-t-2xl">
